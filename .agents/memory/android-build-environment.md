...
**How to apply:** Antes de atribuir un error a Kotlin o Compose, comprobar primero que la ruta del SDK configurada existe y contiene las herramientas de Android; si falta, usar una composición Nix mínima y apuntar `local.properties` al directorio interno `libexec/android-sdk`.